...
![](https://img.shields.io/github/stars/Gkimins/XrayR)
![](https://img.shields.io/github/forks/Gkimins/XrayR)
![](https://github.com/Gkimins/XrayR/actions/workflows/release.yml/badge.svg)
![](https://github.com/Gkimins/XrayR/actions/workflows/docker.yml/badge.svg)
[![Github All Releases](https://img.shields.io/github/downloads/Gkimins/XrayR/total.svg)]()

[Iranian(farsi) README](https://github.com/Gkimins/XrayR/blob/master/README_Fa.md), [Vietnamese(vi) README](https://github.com/Gkimins/XrayR/blob/master/README-vi.md), [English(en) README](https://github.com/Gkimins/XrayR/blob/master/README-en.md)
...
> ⚠️ **توجه: آخرین کامیت به‌طور کامل آزمایش نشده است**
>
> آخرین کامیت (ارتقای xray-core به `v1.260327.0`) تنها از یک خودآزمایی محلی هسته عبور کرده است (build، `go vet`، تست‌های واحد و خودآزمایی ساخت و راه‌اندازی inbound). این کامیت **با** پنل واقعی و ترافیک واقعی کلاینت تأیید نشده است (به‌ویژه شمارش و گزارش ترافیک). بدون آزمایش توسط خودتان، آن را در محیط تولید (production) استفاده نکنید.
...
[Mozilla Public License Version 2.0](https://github.com/Gkimins/XrayR/blob/master/LICENSE)
...
[![Stargazers over time](https://starchart.cc/Gkimins/XrayR.svg)](https://starchart.cc/Gkimins/XrayR)
